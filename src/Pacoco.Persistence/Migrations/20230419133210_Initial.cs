    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedeSoscials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedeSoscials_Eventos_EventoId",
                        column: x => x.EventoId,
                        principalTable: "Eventos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RedeSoscials_Palestrantes_PalestranteId",
                        column: x => x.PalestranteId,
                        principalTable: "Palestrantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedeSoscials_EventoId",
                table: "RedeSoscials",
                column: "EventoId");

            migrationBuilder.CreateIndex(
                name: "IX_RedeSoscials_PalestranteId",
                table: "RedeSoscials",
                column: "PalestranteId");
        }
